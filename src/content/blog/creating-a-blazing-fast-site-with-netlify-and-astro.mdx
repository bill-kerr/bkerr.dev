...
<img
	src="/img/blazing-fast.webp"
	alt="A man on a bicycle going so fast the background is blurry"
	class="h-96 object-cover object-middle rounded-lg w-full"
	height="828"
	width="640"
/>
...
<Alert title="Update">
	Since writing this article, I have transferred the hosting platform to [Cloudflare
	Pages](https://pages.cloudflare.com/). Netlify's [support for custom cache
	headers](https://answers.netlify.com/t/netlify-ignores-cache-control-for-304/2912/1) does not
	enable my use case as outlined by this post.
</Alert>
